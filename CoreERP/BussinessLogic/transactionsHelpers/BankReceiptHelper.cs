            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (var bankDtl in bankReceiptDetails)
                    {
                        ...
                        #endregion
                        _voucherDetail = AddVoucherDetails(repo, bankReceiptMaster, _branch, _voucherMaster, _accountLedger, bankDtl.Amount, bankDtl.ToLedgerId, bankDtl.ToLedgerCode, false);
