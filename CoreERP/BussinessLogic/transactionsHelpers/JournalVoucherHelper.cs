    ...
    public class JournalVoucherHelper
    {
        ...
        public string GetVoucherNo(string branchCode, out string errorMessage)
        {
            try
            {
                ...
                TblJournalVoucherMaster _journalVoucherMaster = null;
                using (Repository<TblJournalVoucherMaster> _repo = new Repository<TblJournalVoucherMaster>())
                {
                    ...
                    {
                        new Common.CommonHelper().GetSuffixPrefix(32, branchCode, out prefix, out suffix);
                ...
                {
                    errorMessage = "JournalVoucher no not gererated please enter manully.";
                }
...
.ToList();
        ...
        public TblVoucherMaster AddVoucherMaster(ERPContext context, TblJournalVoucherMaster journalVoucherMaster, TblBranch branch, decimal? voucherTypeId, string paymentType)
        {
            try
            {
                ...
                var user = context.TblUserNew.Where(x => x.UserName == journalVoucherMaster.UserName).FirstOrDefault();
            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (var bankDtl in journalVoucherDetails)
                    {
                        ...
                        #endregion
                        _voucherDetail = AddVoucherDetails(repo, journalVoucherMaster, _branch, _voucherMaster, _accountLedger, bankDtl.Amount, bankDtl.ToLedgerId, bankDtl.ToLedgerCode, voucherDetail.TransactionType, false);
