...
namespace CoreERP.Controllers.Reports
{
    ...
    public class StockValuationReportController : ControllerBase
    {
        ...
        [HttpGet("GetStockValuationReportData")]
        public async Task<IActionResult> GetStockValuationReportData(DateTime fromDate, DateTime toDate, string UserID)
        {
            try
            {
                ...
                var serviceResult = await Task.FromResult(ReportsHelperClass.GetStockValuationDataList(fromDate,toDate,UserID));
                dynamic expdoObj = new ExpandoObject();
                expdoObj.stockValuationList = serviceResult.Item1;
