...
namespace CoreERP.Models
{
    public partial class Invoice
    {
        ...
        public string Influaction { get; set; }
        ...
        public string Ugsttax { get; set; }
        public string Email { get; set; }
        public string Ext8 { get; set; }
        public string CheckAmount { get; set; }
        public string CheckNo { get; set; }
        public string Rtgsamount { get; set; }
        public string Rtgsid { get; set; }
        public string PhonePay { get; set; }
        public string PayTm { get; set; }
        public string Dbdamount { get; set; }
        public string Ext9 { get; set; }
        public string Ext10 { get; set; }
        public string CompGstno { get; set; }
        public string PartnerCreationCode { get; set; }
        public string PartnerCreationGlaccount { get; set; }
        public string CgstaccNumber { get; set; }
        public string SgstaccNumber { get; set; }
        public string UgstaccNumber { get; set; }
